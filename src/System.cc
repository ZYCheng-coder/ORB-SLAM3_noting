...
namespace ORB_SLAM3 {
    ...
    System::System(const string &strVocFile, const string &strSettingsFile, const eSensor sensor,
        ...
        if (mSensor == MONOCULAR)
            ...
            LOG(INFO) << "Monocular-Inertial" << endl;
        else if (mSensor == IMU_STEREO)
            LOG(INFO) << "Stereo-Inertial" << endl;
        else if (mSensor == IMU_RGBD)
            LOG(INFO) << "RGB-D-Inertial" << endl;
        ...
        if (mStrLoadAtlasFromFile.empty()) {
            ...
            bool bVocLoad = mpVocabulary->loadFromTextFile(strVocFile);  // 加载 ORB字典
            if (!bVocLoad) {
            ...
            //LOG(INFO) << "KF in DB: " << mpKeyFrameDatabase->mnNumKFs << "; words: " << mpKeyFrameDatabase->mnNumWords << endl;
        ...
        LOG(INFO) << "Seq. Name: " << strSequence << endl;
