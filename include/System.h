...
namespace ORB_SLAM3 {
    ...
    public:
        ...
        /// 处理给定的立体相机frame，图像必须同步和校正。
        /// \param imLeft RGB (CV_8UC3) or grayscale (CV_8U)
        /// \param imRight RGB (CV_8UC3) or grayscale (CV_8U)
        /// \param timestamp double
        /// \param vImuMeas
        /// \param filename
        /// \return camera pose (empty if tracking fails)
        ...
        /// 处理给定的rgbd frame，深度图和RGB图需要一一对应
